...
namespace SimpleEntityFramework.Client
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var a = bllSession.CompanyBLL.GetById(1);

            //var b = bllSession.CompanyBLL.Add(new Company()
            //{
            //    Name = "测试",
            ...
            var d = bllSession.CompanyBLL.Modify(new Company()
            {
                Id = 4,
                Name = "测试1",
                LastModifierId = 1,
                LastModifyTime = DateTime.Now
            }, new string[] { "Name", "LastModifierId", "LastModifyTime" });

            //var c = bllSession.CompanyBLL.GetAll();


            //var d = bllSession.CompanyBLL.Del(new Company()
            //{
            //    Id = 4
            //});
